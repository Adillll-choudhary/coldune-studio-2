    ...
    return (
        <section id="services" className="py-24 md:py-44 relative bg-[#0B0D10] overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="flex flex-col lg:flex-row justify-between items-end gap-12 mb-20 md:mb-32">
                    <div className="max-w-3xl">
                        ...
                        >
                            ...
                            <h2 className="text-5xl md:text-9xl font-serif font-bold text-white leading-[0.9] tracking-tighter">
                                Core <br />
